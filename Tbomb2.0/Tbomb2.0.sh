...
banner() {
    ...
    if ! [ -x "$(command -v figlet)" ]; then
        ...
        figlet Rudra ravi
    printf "\033[1;93m[\033[1;77m::\033[1;93m]	    \033[1;92m   Code by : \033[1;97m   Rudra ravi	    \033[1;93m[\033[1;77m::\033[1;93m]"
...
do
    ...
    echo " "
    echo -e "'\033[1;31m                           ⫸ Coded by\033[1;32m Rudra ravi\033[1;31m ⫷\033[0m"

    echo 
    echo -e "'\033[1;36m ⭐⭐⭐⭐⭐⭐⭐⭐⭐⭐⭐⭐⭐⭐ \033[1;32m [Features] \033[1;36m ⭐⭐⭐⭐⭐⭐⭐⭐⭐⭐⭐⭐⭐⭐"
echo " "
echo " "
echo -e " \033[1;31m                         →\033[1;33m  [1] Sms bombing"
echo -e " \033[1;31m                         →\033[1;33m  [2] Call bombing"
echo -e " \033[1;31m                         →\033[1;33m  [3] Email bombing"
echo -e " \033[1;31m                         →\033[1;33m  [5] exit"
echo " "
echo " "
