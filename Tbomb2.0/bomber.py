...
def pretty_print(cc, target, success, failed):
    ...
    mesgdcrt.SuccessMessage("Tbomb2.0 was created by Rudra ravi")
...
def selectnode(mode="sms"):
    ...
    try:
        ...
        max_limit = {"sms": 1000000, "call": 500000, "mail": 2000000}
        cc, target = "", ""
        if mode in ["sms", "call"]:
            cc, target = get_phone_info()
            if cc != "91":
                max_limit.update({"sms": 1000000})
        elif mode == "mail":
